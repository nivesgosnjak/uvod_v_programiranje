...
def enostavno_obrestovanje(polog, mesecna_obrestna_mera, st_mesecev):
    return polog+st_mesecev*polog*mesecna_obrestna_mera
# =====================================================================@000923=
# 2. podnaloga
...
def pretvori_v_letno_obrestno_mero(mesecna_obrestna_mera):
    mera=(1+ mesecna_obrestna_mera)**12 -1
    return round(mera*100)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MjIsInVzZXIiOjEwNjc2fQ:1tmuqQ:HB5IgG8yc-6NJ9mdHmOWx8JM_O_l_ESVltHpfBpFxXU"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MjMsInVzZXIiOjEwNjc2fQ:1tmuqQ:MYslP93rM5LB6lNGvHTCHjKRzeSkS_FeDkTFSaMYzUM"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MzUsInVzZXIiOjEwNjc2fQ:1tmuqQ:_XzFYvDFXznwJgxt8ZBB2qjyLrbhMPUDRtibQdzjtdw"
        try:
