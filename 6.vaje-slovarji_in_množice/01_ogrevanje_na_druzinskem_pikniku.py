...
#     {'pita': 1}
# =============================================================================
def nakupovalni_seznam(slovar,seznam):
    nakupi={}
    for ime in seznam:
        if ime in slovar:
            kljuc=slovar[ime]
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDMzNywidXNlciI6MTA2NzZ9:1tyvgN:HM49ldw4fmMeTTAZK4NmHpVvO-LQuGWc-1YjICldmQ0"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDMzOCwidXNlciI6MTA2NzZ9:1tyvgN:Cqeo4MMU0iXSZKBYDLoEjcZb1fWvNBhbdEHjWoLD1fM"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDMzOSwidXNlciI6MTA2NzZ9:1tyvgN:sLN9Uy95ZW95Yrht5PkyXZT1eDOH5uuxCEmyssFcoWg"
        try:
