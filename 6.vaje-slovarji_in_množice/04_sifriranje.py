...
def ali_je_sifra(slovar):
    ...
    for kljuc in slovar:
        kljuci.append(kljuc)
    for geslo in slovar.values():
        gesla.append(geslo)
    for kljuc in kljuci :
        if kljuc not in gesla:
            return False
    for geslo in gesla:
        if geslo not in kljuci:
            return False
    return True
# =====================================================================@001390=
# 3. podnaloga
...
def inverz(slovar):
    if ali_je_sifra(slovar)==False:
        return None
    return {a:b for b,a in slovar.items()}
# =====================================================================@001391=
# 4. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzg4LCJ1c2VyIjoxMDY3Nn0:1tyvgN:FwYOuM5dJy5tnNa0kSR2arBJeLckGOLw6ZNlknQca1w"
        try:
            nasa_sifra = {'Č': 'K', 'A': 'O', 'C': 'Z', 'B': 'M', 'E': 'V',
                          'D': 'C', 'G': 'P', 'F': 'E', 'I': 'B', 'H': 'F',
                          'K': 'I', 'J': 'A', 'M': 'U', 'L': 'H', 'O': 'R',
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzg5LCJ1c2VyIjoxMDY3Nn0:1tyvgN:44FFpPDJQy242Umxe7Elx01yKF4CFsXz8nAZT7yYClQ"
        try:
            nasa_sifra = {'Č': 'K', 'A': 'O', 'C': 'Z', 'B': 'M', 'E': 'V',
                          'D': 'C', 'G': 'P', 'F': 'E', 'I': 'B', 'H': 'F',
                          'K': 'I', 'J': 'A', 'M': 'U', 'L': 'H', 'O': 'R',
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzkwLCJ1c2VyIjoxMDY3Nn0:1tyvgN:pcJb-7U5w0E1B7cfExK-NW_5UOxFSSDrrbNZhuDSysQ"
        try:
            nasa_sifra = {'Č': 'K', 'A': 'O', 'C': 'Z', 'B': 'M', 'E': 'V',
                          'D': 'C', 'G': 'P', 'F': 'E', 'I': 'B', 'H': 'F',
                          'K': 'I', 'J': 'A', 'M': 'U', 'L': 'H', 'O': 'R',
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzkxLCJ1c2VyIjoxMDY3Nn0:1tyvgN:22REAoYsDxwtarMZM_Nj69Xm-6OQfgtauXAYlajMURg"
        try:
            nasa_sifra = {'Č': 'K', 'A': 'O', 'C': 'Z', 'B': 'M', 'E': 'V',
                          'D': 'C', 'G': 'P', 'F': 'E', 'I': 'B', 'H': 'F',
                          'K': 'I', 'J': 'A', 'M': 'U', 'L': 'H', 'O': 'R',
