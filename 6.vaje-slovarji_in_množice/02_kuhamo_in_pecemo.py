...
def pomnozi(recept,faktor):
    for sestavina in recept:
        recept[sestavina]=recept[sestavina]*faktor
    return recept
# =====================================================================@001393=
# 2. podnaloga
...
def ali_imamo_sestavine(recept, shramba):
    for sestavina in recept:
        if  sestavina not in shramba or shramba[sestavina] < recept[sestavina]:
            return False
    return True
# =====================================================================@001394=
# 3. podnaloga
...
def kaj_moramo_se_kupiti(recept, shramba):
    ...
    for sestavina in recept:
        if sestavina not in shramba:
            listek[sestavina]=recept[sestavina]
        elif shramba[sestavina] < recept[sestavina]:
            listek[sestavina]=recept[sestavina]-shramba[sestavina]
    return listek
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzkyLCJ1c2VyIjoxMDY3Nn0:1tyvgN:kv54byvFDtxQnP84vE6fYlFIndz46wzUHnDTZqojNys"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzkzLCJ1c2VyIjoxMDY3Nn0:1tyvgN:7dKsuejBYraMFUEi711UeXY9jgzxv_nj8Mz-ewpDXDU"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzk0LCJ1c2VyIjoxMDY3Nn0:1tyvgN:bZ3rkZx2JBt07RbM5ELUlCFHg5JOJrPwD17yyoj7TVQ"
        try:
