...
# podano natančnost.
# =============================================================================
def natancni_priblizek(x):
    phi =1
    while phi - naslednji_priblizek(phi)>x or naslednji_priblizek(phi) - phi >x:
        phi = 1 +1/phi
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMDAwLCJ1c2VyIjoxMDY3Nn0:1ttqok:w4SloEdaTc62lLX1udMLv4A8TVni0ZOEqLzrpdftOOk"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMDAxLCJ1c2VyIjoxMDY3Nn0:1ttqok:bFj_S_XcI_bk2X98-8pJR6T54v4AloSMkBQlOQ-Lr54"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMDAyLCJ1c2VyIjoxMDY3Nn0:1ttqok:AzsvdmI7dCQQOyYT0ycwHIbXgfJuFhSWlkBrD_z0-eE"
        try:
