...
# =============================================================================
def pravilni_del_gesla(geslo,crke):
    odgovor=""
    for znak in geslo:
        if znak in crke:
            odgovor += znak
...
#     'j?'
# =============================================================================
def nepravilni_ugibi(geslo,crke):
    narobe=""
    for znak in crke:
        if znak in geslo:
            pass
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNDE3NSwidXNlciI6MTA2NzZ9:1ttqok:26zATsiVyds59LnbYJA3Hihe0yiNUVDF-iPXHhh_Dlc"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNDE3NiwidXNlciI6MTA2NzZ9:1ttqok:XYvA3tZgIKhkCkae-yU8khAywMPpk-SUE0X2-vIb6MM"
        try:
