...
def stirling_vsota(n, k, j):
    if j==0:
        ...
        return ((-1)**j)*binomski(k,j)*((k-j)**n) +stirling_vsota(n,k,j-1)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDAyMywidXNlciI6MTA2NzZ9:1tp8Sh:1hNFfvSWPB75DqjqYe3Wa9T0V0gfbno8qLJ4vWRFNc8"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDAyNCwidXNlciI6MTA2NzZ9:1tp8Sh:2CC4FfrxulbDz6TJrrMqR4tLmVkF48PC5eIDKyr-3Rg"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDAyNywidXNlciI6MTA2NzZ9:1tp8Sh:66VL6eWB5rDqf8hjHZ-YGMAHArDnWSrkZkacYhr9wFw"
        try:
