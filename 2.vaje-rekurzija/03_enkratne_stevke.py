...
def ali_ima_enkratne_stevke(n):
    return kolikokrat_se_pojavi_stevka(0,n)<=1 and kolikokrat_se_pojavi_stevka(1,n)<=1 and kolikokrat_se_pojavi_stevka(2,n)<=1 and kolikokrat_se_pojavi_stevka(3,n)<=1 and kolikokrat_se_pojavi_stevka(4,n)<=1 and kolikokrat_se_pojavi_stevka(5,n)<=1 and kolikokrat_se_pojavi_stevka(6,n)<=1 and kolikokrat_se_pojavi_stevka(7,n)<=1 and kolikokrat_se_pojavi_stevka(8,n)<=1 and kolikokrat_se_pojavi_stevka(9,n)<=1 
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDAyNSwidXNlciI6MTA2NzZ9:1tp8Sh:u2qbOCOm-5FgqQIKhEr-YIATr1MJDnOgSJtNcFsmR0Q"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDAyNiwidXNlciI6MTA2NzZ9:1tp8Sh:ZzRRLXvq6x8s-XWQkuvXa6-xWlE_t7i5t3FuWofoLgs"
        try:
