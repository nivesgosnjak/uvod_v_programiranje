...
def pravokotnik(krogi):
    ...
    for n in range(len(krogi)):
        if x_min > krogi[n][0]-krogi[n][2]:
            x_min=krogi[n][0]-krogi[n][2]
    for n in range(len(krogi)):
        if x_max < krogi[n][0]+krogi[n][2]:
            x_max=krogi[n][0]+krogi[n][2]
    for n in range(len(krogi)):
        if y_min > krogi[n][1]-krogi[n][2]:
            y_min=krogi[n][1]-krogi[n][2]
    for n in range(len(krogi)):
        if y_max < krogi[n][1]+krogi[n][2]:
            y_max=krogi[n][1]+krogi[n][2]
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzExLCJ1c2VyIjoxMDY3Nn0:1twQd5:58oB9UCL-3phO72wS13ez5Vnn3vmVIg0vBd5ZAN2NY4"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzEyLCJ1c2VyIjoxMDY3Nn0:1twQd5:MJ6JuymahbyFndeWwTk2MkpxEg_Xne7MKAtnCxkPb0Q"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzEzLCJ1c2VyIjoxMDY3Nn0:1twQd5:NsdrFn8dlECrOJ-bezxw5OrZdGP8V5LFigydqzjG12M"
        try:
