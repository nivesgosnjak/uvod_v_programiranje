...
def dolzina_zaporedja(n):
    if n==1:
        ...
        nov_n=naslednji_clen(n)
        return 1+dolzina_zaporedja(nov_n)
# =====================================================================@000948=
# 3. podnaloga
...
def najvecji_clen(n):
    if n==1:
        return 1
    elif naslednji_clen(n)==1:
        return n
    else:
        if n>naslednji_clen(n):
            return max(n, najvecji_clen(naslednji_clen(n)))
        else:
            return max(naslednji_clen(n), najvecji_clen(naslednji_clen(n)))
# =====================================================================@000949=
# 4. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NDYsInVzZXIiOjEwNjc2fQ:1tp8Sh:HerYNeYPyb1hJw46XwfRYxS6j3h3AXOXxIoULEgDyOI"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NDcsInVzZXIiOjEwNjc2fQ:1tp8Sh:Vyifk4aDfWwgWIs_X9BotbaSBj2UKKWpMW46MwVHZhI"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NDgsInVzZXIiOjEwNjc2fQ:1tp8Sh:ZYxfSibA7q38eXTb-wfIivHTOzpuR-r_OyX67rqXzdc"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NDksInVzZXIiOjEwNjc2fQ:1tp8Sh:Qx3ik1hVOS2Za7vkPZQhFMVPz7B5i5Ex8YqM_CgdX8U"
        try:
