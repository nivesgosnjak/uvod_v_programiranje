...
def vsota_vecjih_stevk(n, k=0):
    ...
    if n==0:
        ...
        return n%10 + vsota_vecjih_stevk(nov_n,k)
    else:
        return vsota_vecjih_stevk(nov_n,k)
...
def najmanjse_stevilo_z_vsoto_stevk(n):
    if n<10:
        ...
        n2=n-9
        return 9+10*najmanjse_stevilo_z_vsoto_stevk(n2)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTYsInVzZXIiOjEwNjc2fQ:1tp8Sh:b8bOiixabMXZioas6hpLqh7Svcc1vAmZFVuAC-3PKJ4"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTcsInVzZXIiOjEwNjc2fQ:1tp8Sh:JCTWvb9dsVussE-C-LFBg2BHw-5GLlMzjUPNMFpx97c"
        try:
            try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTgsInVzZXIiOjEwNjc2fQ:1tp8Sh:kTmeg-WIfYLWdzKnW-hulhl-trsz3PEHP2z8zJX3xY8"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTksInVzZXIiOjEwNjc2fQ:1tp8Sh:3P7nowHFi7WS7pKNDZg_zTN4eUBoXVWJHVXCKxT_1KQ"
        try:
            for i in range(1, 100):
